...
class Borrower extends FormRequest
{
    ...
    public function rules()
    {
        return [
			...
			'address2' => 'nullable',
			'telephone_no' => 'required_if:borrower_cat,value2,value3,value4,value6,value7,value8,value9|max:17',
			'spouse_name' => 'required_if:borrower_cat,value4|max:50',
			'address1' => 'required_if:borrower_cat,value3,value4,value6,value7,value8|max:120',
			'city' => 'required_if:borrower_cat,value3,value4,value6,value7,value8|max:50',
			'province_state' => 'required_if:borrower_cat,value3,value4,value6,value7,value8|max:50',
			'postal_code' => 'required_if:borrower_cat,value3,value4,value6,value7,value8|max:20',
