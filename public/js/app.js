...
$.fn.update_fields_info = function ($value) {
	switch($value) {
		case 'value1':
			...
			$('#otherValueEmail').remove('no-display').fadeIn('slow').find('input, select, textarea').prop('disabled', false);
			$('#AlumniValueEmail').add('no-display').hide().find('input, select, textarea').prop('disabled', true);
		...
		case 'value2':
			...
			$('#AlumniValueEmail').remove('no-display').fadeIn('slow').find('input, select, textarea').prop('disabled', false);
			$('#otherValueEmail').add('no-display').hide().find('input, select, textarea').prop('disabled', true);
			$.fn.clear_address_values();
